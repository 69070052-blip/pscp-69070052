...
เศษ r
output:
ตัวที่หาร d ได้เศษ r
constraints:
A น้อยกว่า B ต้องระวัง และ d > r
```
...
```text
Step 1: รับค่า A B d r
Step 2:ใช้ for loop หาจำนวณที่หาร d และได้เศษ r
Step 3:แยกนับไว้
Step 4:พิมพ์จำนวณที่นับได้ออกมา
```
...
```text
เช็คว่าถ้าเศษเป็น 0 ต้องนับทุกจำนวณ
```
