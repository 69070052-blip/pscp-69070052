...
```text
input:
รับค่าจำนวณร้าน และจำนวณเวลาที่ต้องตรวจสอบ
output:
จำนวณร้านที่เปิดเวลานั้นและคั่นด้วยช่องว่างบรรทัดเดียว
constraints:
เวลาที่ใช้ตรวจสอบอยู่ในช่วง 0 ถึง 1440
```
...
```text
Step 1: รับจำนวณร้านและจำนวณช่วงเวลาที่ตรวจสอบ
Step 2: ใช้ loop รับค่าช่วงเวลา
Step 3: คำนวณจำนวนร้านที่เปิดจริงในแต่ละนาที
Step 4: ให้แสดงร้านที่เปิดในช่วงเวลานั้นๆ
```
...
```text
วิธีเหมือนแผนแรก  รับจำนวณร้านและช่วงเวลาที่ร้านเปิด แบ่งคำนวณเวลาที่เปิดร้านว่ามีร้านไหนเปิดบ้างจากนั้นก็เก็บร้านที่เปดไว้ใน list
```
...
```text
เปิดถึงก่อนเวลา stop 1 นาที จะไม่นับว่าเปิด
```
...
```text
มีร้านที่ปิดเวลาเดียวกับที่อีกร้านเปิดพอดี
```
