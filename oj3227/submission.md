...
```text
input:
รับแต้มของไพ่และกลุ่มของไพ่
output:
แสดงผลตามชื่อของไพ่
constraints:
input เป็นตัวอักษร 1 ตัว หรือ จำนวนเต็ม 1 จำนวนตั้งแต่ 2 - 10
```
...
```text
Step 1: รับค่ามาและแยกออกเป็น2ค่าและกำหนดให้เป็น upper
Step 2: กำหนด dic ไว้เรียกใช้
Step 3: พิมพ์ไพ่ออกมาโดยใช้ dic
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก แต่ใช้คำสั้งgetเพื่อดึงใช้dic จำนวณแต้มหากไม่พบในdicจะพิมพ์เลขนั้นออกมาแทน
```
...
```text
เช็คว่าcode ได้ดึงจากdic มาใช้รึป่าว
```
