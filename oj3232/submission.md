...
```text
input:
กระโดดได้ระยะ X เมตร จนกว่าจะถึงระยะ Y เมตร
output:
จํานวนครั้งกระโดดขั้นตํ่า หรือ -1 ถ้าไปไม่ถึง
constraints:
1 ≤ X ≤ 1000
1 ≤ Y ≤ 100000
```
...
```text
Step 1: รับค่าที่กระโดด กับจุดที่ต้องไปถึง
Step 2: ใช้ while ในการคำนวณว่ากระโดดไปถึงหรือป่าว โดยที่ระยะกระโดดจะลดลงทีละ2
Step 3: ถ้าไปถึงให้พิมพ์จำนวณครั้งที่กระโดด ถ้าไม่ให้พิมพ์ -1
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้while ในการคำนวณหากกระโดดไม่ถึงให้-2 ไปเรื่อยจนกว่าจะถึงหรือถ้าไปไม่ถึงให้พิมพ์ -1
```
...
```text
เช็คว่าไม่ต้องกระโดดก็สามารถถึงได้
```
