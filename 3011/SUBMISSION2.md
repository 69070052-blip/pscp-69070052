...
รับแม่สีมา1คู๋
output:
ควรเป็นสีที่ผสมออกมาแล้ว
Constraints:
input ควรคิดกรณีที่เป็นคู่สีเดียวกันด้วย
```
...
```text
Step 1:รับ input มา2สีกำหนดให้เป็น co1, co2
Step 2:ใช้เงื่อนไขถ้าสีแดงผสมกับเหลืองกลายเป็นฟ้า, ถ้าแล้วแดงผสมกับฟ้าเป็นม่วง ถ้าแล้วเหลืองผสมฟ้าเป็นเขียว
Step 3:ถ้าเป็นอื่นให้พิมพ์Error
```
...
Step 1:รับ input มา2สีกำหนดให้เป็น co1, co2
Step 2:ใช้เงื่อนไขถ้าสีแดงผสมกับเหลืองกลายเป็นฟ้า, ถ้าแล้วแดงผสมกับฟ้าเป็นม่วง ถ้าแล้วเหลืองผสมฟ้าเป็นเขียว
Step 4:ถ้าเป็นสีเดียวกันให้พิมพ์สีนั้นออกมา
Step 5:ถ้าเป็นอื่นให้พิมพ์Error
```
...
```text
ตรวจการทำงานของโปรแกรมว่าoutputออกมาตรงหรือไม่
```
...
```text
ตรวจelseว่าถ้าไม่เจอสีที่กำหนดไว้จะขึ้น Error ตามที่กำหนดไว้รึป่าว
```
...
```text
ตรวจสอบว่าสีเดียวกันจะพิมพ์ออกมาอย่างไร
```
...
```text
ช่วยให้hintเรื่องที่กรณี test case เป็นสีเดียวกัน
```

คุณยังทำอะไรด้วยตนเอง

```text
เพิ่มเงื่อนไขลงในCodeในกรณีที่เลือกคู่สีเดียวกัน จากนั้นลองทดสอบใน Vs code แล้วส่งOJด้วยตัวเอง
```
