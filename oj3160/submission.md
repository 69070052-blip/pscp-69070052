...
```text
input:
เลขเริ่มต้น และ เลขตัวสุดท้าย
output:
เลขจำนวณเฉพาะที่อยู่ใน range ทั้งหมด
constraint:
เป็นลบไม่ได้
```
...
```text
Step 1: รับค่าเริ่มต้น และ หยุด
Step 2: ใช้ loop หาค่า prime โดยการหาเลขที่หารค่านั้นลงตัว
Step 3: ถ้าเจอค่า prime ให้เพิ่มเข้าไปในลิส
Step 4: ให้นับจำนวณที่เจอค่า prime
Step 5: ให้พิมพ์์ตค่าprime ทั้งหมด และ จำนวณค่า prime โดยเว้นบรรทัด
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยใ้ชวิธี loop หาค่าที่หารมันลงตัวไปเรื่อยๆ
```
...
```text
หากไม่มีค่า prime จะไม่พิมพ์  ค่าที่เจอ
```
...
```text
เช็คว่าไม่เกิดข้อผิดพลาดจากการ loop
```
