...
```text
input:
ต้องรับค่าการแผ่ขยายตัวของน้ำหมึก และจำนวนพิกัดบ้านของผู้คน
output:
วินาทีที่น้ำหมึกขยายไปถึงบ้านชาวบ้านในกี่วินาที
constraints:
ใช้ค่า pi เป็น3.1416 และจำนวนค่าพิกัดที่ต้องรับ
```
...
```text
Step 1:ใหรับค่าการแผ่ขยายของหมึกต่อวินาที และจำนวนพิกัดของบ้านคนที่ i
Step 2:คำนวณหารัศมีที่แผ่ขายออกไปต่อวินาที
Step 3:คำนวณวินาทีที่ขยายไปถึงบ้าน
```
...
```text
เหมือนกับวิธีแรก เพราะเราต้องหาความเร็วต่อวินาทีก่อนถึงจะไปหาวินาทีที่ไปถึงบ้านได้ แต่ต่างกันตรงที่วิธีแรกoutputโดยติดfloat ทำให้ผลออกมาไม่ตรงเลยกำกับให้ออกมาเป็นจำนวณจริง
```
...
```text
ทดสอบว่าได้ค่า output ที่ต้องการหรือไม่
```
...
```text
เช็คว่าค่าที่ออกมาจะไม่มีทศนิยม
```
...
```text
เช็คว่าค่าที่รับเข้าไปเป็น 0  0 ควรออกมาเป็น 0 เพราะหมึกตกลงมาในวินาทีที่0
```
