...
```text
input:
รับค่าต้นทางปลายทาง และน้ำหนักวัสดุุ
output:
ผลรราคาที่คิดค่าน้ำหนักกับระยะทางมาแล้ว
constraints:
...
```text
Step 1: รับค่าต้นทางปลายทาง
Step 2: ใช้เงื่อนไขในการเช็คต้นทางปลายทาง
Step 3: รับค่าน้ำหนัก
Step 4: คำนวณค่าธรรมเนียม
Step 5: ถ้าค่าาไม่อยู่ในเงื่อนไขให้พิม Error
```
...
```text
ใช้วิธีเหมือนแผนแรก แต่ตอนเช็คต้นทางกับปลายทางใช้ dic ในการเก็บค่า
```
