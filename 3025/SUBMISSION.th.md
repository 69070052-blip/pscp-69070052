...
ชื่อฤดูกาล
constraints:
ฤดูกาลจะเปลี่ยนในวันที่ 21 ของทุกๆ3เดือน
```
...
Step 2:เช็คกรณีของแต่ละเดือนถ้าเดือน1-2 4-5 7-8 11-12 ให้พิมพ์ฤดูการเดิมออกมา
Step 3:ถ้าเป็นเดือน 3 6 9 12 และเป็นวันที่21
ให้พิมพ์ฤดูการถัดไป 
```
...
```text
Step 1:รับค่าเดือนกับวัน
Step 2:เช็คกรณีของแต่ละเดือน
Step 3:ถ้าเป็นวันที่21ของเดือนที่่3,6,9,12 ให้เป็นฤดูการต่อไป
Step 4:ถ้าไม่ให้พิมพ์ฤดูการเดิม
```
...
```text
เช็คกรณีของเดือน 3 6 9 12 ที่วันที่21
```
...
```text
เช็คการทำงานที่เป็นวันที่21 แต่ไม่ใช่เดือน 3 6 9 12
```
...
```text
เช็ควันปกติที่ไม่ใช่วันที่21 และไม่ใช่เดือน 3 6 9 12
```
...
```text
แก้bug เขียนโค้ด รันtestcase ส่งOJด้วยตนเอง
```
