...
```text
input:
รับค่าว่าเป็นสมาชิกหรือไม่ , จำนาณรายการที่ซื้อ , ราคาสินค้าาแต่ละรายการ
output:
ยอดสุทธิหลังหักส่วนลด
constraints:
ให้ปัดเศษและ output เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับค่าตัวอักษร Y หรือ N
Step 2: ใช้ loop รับค่าราคาสินค้า
Step 3: ตรวจสอบเงื่อนไข
Step 4: คำนวณราคาสุทธิ
```
...
```text
วิธีเหมือนกับแผนแรก รับค่าสมาชิกจากนั้นใช้ loop ในการรับค่าราคาสินค้า จากนั้นเช็คเงื่อนไข และคำนวณราคาสุทธิ
```
...
```text
เช็คว่าถ้าไม่ใช่สมาชิกคำนวณถูกไหม
```
...
```text
เช็คว่าถ้าเป็นสมาชิกคำนวณถูกไหม
```
...
```text
ถ้าราสินค้าเท่ากับ0 ทศนิยมควรมีสองตำแหน่งเหมือนเดิม
```
