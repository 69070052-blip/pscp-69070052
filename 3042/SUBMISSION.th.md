...
ค่าที่เต็มบวก
output:
ค่าที่ต้องหารด้วย10ลงตัวและลดทีละ10ไปเรื่อยๆ
constraints:
ต้องคั่นด้วยช่องว่างเวลา output
```
...
```text
Step 1:รับค่าเต็มบวก
Step 2:ทำให้เป็นค่าที่10หารลง
Step 3:ทำให้พิมค่าลดทีละ10ไปเรื่อยๆ
```
...
Step 1:รับค่าเต็มบวก
Step 2:ทำให้เป็นค่าที่10หารลง
Step 3:ให้พิมพ์โดยเว้นช่องว่างลดลงทีละ10ไปเรื่อยๆ
Step 4:ให้พิมพ์ศูนย์ปิดท้าย
```
...
```text
ควรพิมพ์ออกมาแค้ 0 ไม่เพิ่มเป็น 0 0
```
...
```text
ถ้าหาร10ไม่ลงต้องทำให้หาร10ลงก่อนค่อยดำเนินการ
```
...
```text
เช็คว่ามันดำเนินการถูกต้องหรือไม่
```
