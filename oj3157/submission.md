...
```text
Step 1: รับค่าจำนวณที่ต้องรับ +-
Step 2: ใช้ loop รับค่า + -
Step 3: หากรับเป็น+ ให้point เพิ่มขึ้น10
Step 4: หากรับเป็น - ให้point ลดลง5
step 5 ให้พิมพ์แต้มที่คำนวณออกมา
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้loop การรับ +- ตามจำนวณ และใช้เงื่อนไขบวกลบแต่มตามเงื่อนไข
```
