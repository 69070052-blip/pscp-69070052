...
รับค่าข้อความมา
output:
จำนวณสระ a e i o u ที่นับได้
constraints:
ต้องนับได้ทั้งพิมใหญ่พิมเล็ก
```
...
```text
Step 1:รับค่าข้อความมา
Step 2:สร้าง list เอาไว้นับ a e i o u
Step 3:ใช้ for loop นับ a e i o u
Step 4:พิมพ์ออากมาทีละตัวว่ามีตัวลัเท่าไหร่
```
...
```text
Step 1:รับค่าข้อความมา แปลงเป็นตัวพิมพ์เล็กทั้งหมด
Step 2:สร้าง list เอาไว้นับ a e i o u
Step 3:ใช้ for loop นับ a e i o u
Step 4:ใช้ for loop พิมพ์ตัวสระและจนวณที่นับได้ออกมาเลย
```
...
```text
เช็คว่าทำนับไดทั้งพิมใหญ่พิมเล็ก
```
...
```text
เช็คว่ามันทำงานได้ปกติ
```

Input:

```text
ijudge.it.kmitl.ac.th
```
