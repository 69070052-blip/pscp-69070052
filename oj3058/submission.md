...
```text
input:
อิฐก้อนเล็กนำนวณ a ก้อน
อิฐก้อนใหญ่จำนวณ b ก้อน
ต้องการาร้างสะพาน goal นิ้ว
output:
จำนวนอิฐก้อนเล็กที่ต้องใช้  ถ้าสร้างไม่ได้พิม -1
constraints:
จะใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนเสมอ ต้องสร้างให้พอดีกับ goal นิ้ว ถ้าก้อนใหญ่มีเกิน ก็ให้ใช้เท่าที่ใช้ได้ แล้วนำก้อนเล็กมาโปะ
```
...
```text
Step 1: รับค่าอิฐเล็กใหญ่ และ goal
Step 2:หาจำนวณหินก้อนใหญ่ที่ใช้มากที่สุด
Step 3:หาจำนวณอิฐก้อนเล็กในระยะทางที่เหลือ
Step 4:ถ้าใช้จำนวนหินเล็กน้อยกว่าหรือเท่ากับให้พิมออกมา
Step 5:ถ้าไม่ พิม -1
```
...
```text
เหมือนกับแผนแรก เพื่อตรวจหินก้อนใหญ่ก่อนเสมอ ละหาระยะทางที่เหลือเพื่อเอาหินก้อนเล็กมาโปะ
```
...
```text
เพื่อเช็คว่ามันสามารถตอบเป็น 0 ได้
```
...
```text
หากอิฐก้อนเล็กถึงให้พิมจำนวนออกมา
```
