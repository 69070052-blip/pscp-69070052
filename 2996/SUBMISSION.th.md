...
```text
จงเขียนชื่อกลับหลังและพิมพ์เป็นตัวพิมพ์เล็ก
input:
รับชื่อด้วยค่า name
output:
ควรแสดงผลกลับด้านและเป็นตัวพิมเล็ก
Constraints:
ถ้า input ตัวแรกเป็นตัวพิมใหญ่ควรทำให้ output เป็นตัวพิมเล็ก
```
...
```text
Step 1:รับชื่อมาใส่ใน name
Step 2:ให้พิมพ์ name กลับหลังและบังคับให้เป็นตัวพิมพ์เล็ก
```
...
```text
เหมือนกับแผนแรก ให้ชื่อรับค่าใน name และสั่งพิมพ์ name กลับหลังและบังคับให้เป็นตัวพิมพ์เล็กจากนั้นตรวรสอบกรณีที่รับค่าตัวอรกมาเป็นตัวพิมพ์ใหญ่
```
...
```text
ตรวจสอบว่าโค้ดทำงานตรงกับ output หรือไม่
```
...
```text
ตรวจสอบว่าตัวพิมพ์ใหญ่กลายเป็นตัวพิมพ์เล็กหรือไม่
```
...
```text
แปลงค่ากลับเป็นค่าค่าเดิมเช็คความถูกต้อง
```
...
```text
ออกแบบcode ด้วยตัวเอง รันtest case เช็คใน VS code ด้วยตัวเอง และส่งงานในOJด้วยตัวเอง
```
