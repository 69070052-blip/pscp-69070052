...
input:
ตัวเลขอุณหภูมิ
หน่วยอุณหภูมิดั้งเดิม
หน่วยอุณหภูมิที่เปลี่ยน
output:
ค่าตัวเลขอุณหภูมิที่เปลี่ยนแล้ว
constraints:
สมการของแต่กรณี
```
...
```text
Step 1:รับค่าinput
Step 2:แยกกรณีของอุณหภูทิแต่ละหน่วย
Step 3:print ค่าตัวเลขที่ผ่านเงื่อนไขและคำนวณออกมาแล้ว
```
...
```text
เหมือนกัน เพราะหลักการทำงานมันครอบคลุมทุกกรณี
```
...
```text
เช็คกรณีที่เปลี่ยนเป็นหน่วยเดิม
```
...
```text
การทำงานของแต่ละกรณีทำงานได้ปกติ
```
...
```text
เช็คค่าติดลบว่าแสดงออกมาหรือไม่
```
...
```text
คิดสมการแต่ละเงื่อนไข
```

คุณยังทำอะไรด้วยตนเอง

```text
เช็คสมการที่เพื่อนคิดด้วยตัวเอง เขียนโค้ดด้วยตนเอง และส่งด้วยตนเอง
```
