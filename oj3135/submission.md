...
```text
input:
จำนวณคน รอบที่ส่ง ตำแหน่งโจร
output:
จำนวณที่ได้ดูของขวัญ
constraints:
เป็นได้แค่จำนวณเต็มบวก
```
...
```text
Step 1: รับค่าจำนวณคน ส่งให้คนถัดไป ตำแหน่งโจร
Step 2: ใช้ loop หาจำนวณครั้งที่ส่งให้คนถัดไป
Step 3: แล้วพิมจำนวณคนที่ได้ดู
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก แต่เพิ่มเงื่อไขหากโจรเป็นคนแรก ให้พิมพ์ 1
```
...
```text
เช็คว่าถ้าโจรเป็นคนแรกจะไม่ถูกนับต่อ
```
...
```text
เช็คว่ามันสามารถเช็คได้ถึงตัวสุดท้าย
```
