...
```text
input:
ผลการออกรางวัลสลากกินแบ่ง และ ตัวอักษร และ หมายเลขสลากที่กระต่ายน้อยซื้อ
output:
ตัวอักษร และ หมายเลขสลากที่กระต่ายน้อยซื้อ
constraints:
ถ้าไม่ถูกรางวัล ให้แสดงผลลัพธ์เป็น 0
```
...
```text
Step 1: รับค่าที่ถูกรางวัล และค่าที่กระต่ายซื้อ
Step 2: เช็คตามเงื่อนไขว่าจะได้เงินรางวัลเท่ไหร่
Step 3: พิมพ์เงินรางวัลที่ได้รับออกมา
Step 4: ถ้าไม่ถูกรางวัลพิมพ์ 0
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้เงื่อนไขว่าถ้าถูกหมดได้รางวัล 1000000 ถูกแค่เลขได้ 100000 และเช็คอย่างนี้ไปเรื่อยๆ
```
...
```text
เช็คว่าสามารถตรวจสอบเลท้ายได้หรือไม่
```
...
```text
เช็คว่าถ้าไม่ถูกเลยจะไม่ได้เงิน
```
